...
Object.assign(I18N.en, {
  ...
  "释义、视频原句与译文、新例句与译文将拼接写入一个背面字段。所选笔记类型的卡片模板须在正反面显示这两个字段。": "The meaning, video sentence and translation, and new example and translation are combined into one back field. The card template must display the selected fields on the respective sides.",
  "词语字段": "Term field",
  "释义字段": "Meaning field",
