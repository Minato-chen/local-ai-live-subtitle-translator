...
test("creates a playback reference only from known title and time", () => { assert.equal(s.playbackReference({ title: "Episode S2E3 - Netflix", hostname: "www.netflix.com", seconds: 155 }), "Episode S2E3 · S02E03 · 约 02:35"); assert.equal(s.playbackReference({ title: "", hostname: "www.netflix.com", seconds: 155 }), ""); });
