(function (root, factory) {
  ...
  return { DICTIONARY_SCHEMA, DICTIONARY_PROMPT_TEMPLATE, buildDictionaryMessages, dictionaryResponseFormat, parseDictionaryResponse, inferSourceLanguage, isLanguagePlausible, isTargetLanguage, needsDefinitionRepair, isConciseDefinition, isPlausiblePronunciation, sameExample, classifyExamplePair };
});
