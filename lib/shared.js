(function (root, factory) {
  ...
  return { normalizeSelection, tokenizeWordBlocks, wordBlockRange, selectionIssue, validateLoopbackHttpUrl, escapeHtml, toAnkiHtml, sourceTags, computeFloatingPosition };
});
